"""Run a minimal-checkpoint reconstruction on a horizontally flipped validation clip.

source .venv/bin/activate
python scripts/check/visualize_minimal_reconstruction_hflip.py \
  --checkpoint outputs/minimal/ae_only_single_grasp_ep0_f111_116/checkpoints/last.pt \
  --output-dir outputs/minimal/ae_only_single_grasp_ep0_f111_116/samples/step_001700_hflip
"""
...
from world_model_v2.minimal.dataset import load_minimal_clip
from world_model_v2.minimal.experiment import checkpoint_ae_backend, load_minimal_checkpoint
...
def parse_args() -> argparse.Namespace:
    """Parse CLI arguments for the flipped minimal reconstruction check."""
...
def build_model_from_checkpoint(
    ...
    """Instantiate the minimal model using serialized checkpoint config."""
...
def reconstruct_flipped_clip(
    ...
    checkpoint = load_minimal_checkpoint(checkpoint_path, device_obj)
...
def main() -> None:
    """Run the flipped minimal reconstruction CLI."""
