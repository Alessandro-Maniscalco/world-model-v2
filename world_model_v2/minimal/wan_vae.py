"""Wan-style VAE blocks adapted for minimal single-frame world-model experiments."""
...
class WanVAEConfig:
    """Configure the minimal Wan-style VAE backend."""
    ...
    def __post_init__(self) -> None:
        """Validate the shape of the minimal Wan-style configuration."""
...
class WanEncoder3d(nn.Module):
    ...
    def __init__(self, cfg: WanVAEConfig) -> None:
        """Create the minimal Wan-style encoder backbone."""
...
class WanDecoder3d(nn.Module):
    ...
    def __init__(self, cfg: WanVAEConfig) -> None:
        """Create the minimal Wan-style decoder backbone."""
